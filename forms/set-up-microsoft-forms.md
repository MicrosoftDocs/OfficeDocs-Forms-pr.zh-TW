...
## <a name="configure"></a>[設定](#tab/configure)
...
<thead>
<tr class="header">
<th><strong>系統管理員工作</strong></th>
<th><strong>描述</strong></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td><strong>關閉或開啟 Microsoft Forms</strong></td>
<td>貴組織的 Microsoft Forms 預設為開啟。 您可以隨時 <a href="https://support.microsoft.com/office/turn-off-or-turn-on-microsoft-forms-8dcbf3ab-f2d6-459a-b8be-8d9892132a43">將它關閉</a>。</td>
</tr>
<tr class="even">
<td><strong>針對貴組織中的個別人員關閉 Microsoft Forms</strong></td>
<td>當您關閉特定人員的 Microsoft Forms 時，他們將無法使用 Microsoft Forms，而且 <strong>Forms</strong> 圖格也不會顯示在 Microsoft 365 應用程式啟動器或首頁中。  了解如何 <a href="https://support.microsoft.com/office/turn-off-or-turn-on-microsoft-forms-8dcbf3ab-f2d6-459a-b8be-8d9892132a43">關閉特定人員的表單</a>。 </td>
</tr>
<tr class="odd">
<td><strong>設定適用於 Microsoft Forms 的 Azure Active Directory 條件式存取</strong></td>
<td><p>若要設定 Microsoft Forms 的條件式存取原則，請參閱 <a href="/azure/active-directory/conditional-access/">Azure AD 條件式存取文件</a>，並在 <strong>雲端應用程式</strong> 指派中包含 <strong>Microsoft Forms</strong>。</p>
<p><strong>注意：</strong>如果您組織中的使用者在您設定 Microsoft Forms 的條件式存取之後仍遭到封鎖，請確定 SharePoint Online 和 Exchange Online 也透過條件式存取獲得存取權。 <a href="/azure/active-directory/conditional-access/conditional-access-for-exo-and-spo">深入了解</a>。</p></td>
</tr>
<tr class="even">
<td><strong>控制外部共用設定、記錄貴組織中人員的名稱，和/或保護表單不受網路釣魚的攻擊</strong></td>
<td><p>在 Microsoft 365 系統管理中心，您可以：</p>
<ul>
<li><p>控制是否允許外部使用者與貴組織中的使用者在表單或測驗上共同作業。</p></li>
<li><p>選擇是否要擷取貴組織中填寫表單的人員名稱。</p></li>
<li><p>關閉或開啟表單上的自動化網路釣魚偵測。</p></li>
</ul>
<p>深入了解這些 <a href="https://support.microsoft.com/office/administrator-settings-for-microsoft-forms-48161c55-fbae-4f37-8951-9e3befc0248b">系統管理員設定</a>。</p></td>
</tr>
<tr class="odd">
<td><strong>讓使用者可以將表單插入 PowerPoint</strong></td>
<td><ol type="1">
<li><p>登入 <a href="https://admin.microsoft.com/">https://admin.microsoft.com</a>.</p></li>
<li><p>按一下 <strong>[設定]</strong> &gt; <strong>[設定]</strong>。</p></li>
<li><p>在 <strong>[設定]</strong> 頁面上的 <strong>[服務]</strong> 索引標籤底下，按一下 <strong>使用者擁有的應用程式和服務</strong>。</p></li>
<li><p>請勾選此選項，<strong>讓使用者存取 Office 市集</strong>，允許使用者將表單插入 PowerPoint 中。</p></li>
</ol>
<blockquote>
<p>請注意，變更生效可能需要數小時。 <a href="/office365/admin/manage/manage-deployment-of-add-ins>Learn more</a>.</p>
</blockquote></td>
</tr>
</tbody>
</table>
...
## <a name="security--compliance"></a>[安全性與合規性](#tab/security)
...
截至 2018 年 5 月，Microsoft Forms 已符合 GDPR 合規性要求。 如需詳細資訊，請參閱 [適用於 GDPR 的 Microsoft365 資料主體要求](/microsoft-365/compliance/gdpr-dsr-office365?toc=/microsoft-365/enterprise/toc.json)。
